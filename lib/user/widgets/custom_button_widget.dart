...
class CustomButton extends StatelessWidget {
  ...
  final double verticalPadding;
  final Icon? icon; // Optional icon parameter
  final bool isDisabled; // New parameter to disable the button
  ...
  CustomButton({
    ...
    this.verticalPadding = 15,
    this.icon,
    this.isDisabled = false, // Default value for isDisabled
  });
              ...
              style: TextStyle(
                color: buttonController.isPressed.value
                    ...
                    : (isDisabled
                        ...
                        : CustomColors
                            .textColorThree), // Change text color if disabled
                fontSize: 16,
                fontWeight: FontWeight.w500,
              ),
              child: Row(
